...
We present here a dataset of 79,890 entangled sequences collected through large-scale sequence screening, ESMFold structure prediction and a series of data cleaning steps. Sequences and all other information (e.g. functions, organisms, calculated binding energies) are availbale at `data/Uniref50_entangled_homodimer.csv`. The ESMFold-predicted homodimeric structures are available at FigShare (https://doi.org/10.6084/m9.figshare.29604998.v1).
